...
if __name__ == "__main__":
    # JSON 파일 로드
    input_path = "../data/json/26540_result_4b4edc2630 - 복사본.json"
    output_path = "../data/result/scene_result.json"
    ...
    try:
        ...
        # 전체 데이터 후처리 실행 (기본 정보 + 비디오 + 클립 + Scene)
        ...
        print(f"Scene 후처리 완료: {output_path}")
